...
| **CI/CD Automation** | Configured GitHub Actions workflow to run on push/PR, install dependencies, run Newman, and upload artifacts. | `.github/workflows/api-tests.yml` | **YES** |
