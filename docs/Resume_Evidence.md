...
| **CI/CD Automation** | Configured GitHub Actions workflow to run on push/PR, install dependencies, run Newman, and upload artifacts. | `.github/workflows/api-tests.yml` | **VERIFIED ON GITHUB ACTIONS CI/CD (Run #4, ID 34155665063 — Node 24, Success, Report Artifact Uploaded)** |
